...
namespace OcrMyImage.Application.ImageProcessors
{
    internal class ImageProcessor
    {
        ...
        public static Image GetImageFromByteArray(byte[] image)
        {
        ...
        public static Bitmap GetAsBitmapFromArray(byte[] img, int dpi)
        {
            try
            {
            ...
            {
                throw new InvalidBitmapException(" Hocr.ImageProcessors.ImageProcessor - GetAsBitmapFromArray", e);

            }
        }

        public static byte[] ScaleImage(byte[] image, int width = 3000)
        {
            try
            {
                using (var outStream = new MemoryStream())
                {
                    MagicImageProcessor.ProcessImage(image, outStream, new ProcessImageSettings { Width = width });
            ...
            catch (Exception e)
            {
                ...
                throw new ImageCannotScaledException("Görüntü yeniden boyutlandırılamadı. Genişlik parametresi " + width.ToString(), e);
            }
        }
    }
}
